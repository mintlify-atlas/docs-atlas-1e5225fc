---
title: "Repository Structure and File Naming Conventions"
...
│   ├── Clase 2/          # Enums, varargs, static members
│   ├── Clase 3/          # Access modifiers, method overriding
│   ├── Clase 4/          # Polymorphism
│   ├── Clase 5/          # Casting, Object class, abstract classes
│   ├── Clase 7/          # Interfaces
│   ├── Clase 8/          # JavaBeans conventions
│   ├── Clase 9/          # Exception handling in Java
│   └── Clase 10/         # Console application capstone (UML + implementation)
│
├── Python/
│   ├── Clase 1/          # Exception handling fundamentals
│   ├── Clase 2/          # File I/O
│   ├── Clase 3/          # Advanced file processing
│   ├── Clase 4/          # psycopg2: connecting to PostgreSQL
│   ├── Clase 5/          # psycopg2: CRUD operations
│   ├── Clase 6/          # Transaction management with psycopg2
│   ├── Clase 7/          # Logging (+ UML diagram .uxf)
│   ├── Clase 8/          # DAO pattern: Persona class and PersonaDAO
...
│   ├── Clase 4/          # Arrow functions and OOP patterns
│   ├── Clase 5/          # Callbacks
│   ├── Clase 6/          # setTimeout, setInterval, live clock project
│   ├── Practica JS/      # Standalone JS practice exercises
│   └── Area Juegos - Clase 1/
...
The Java section spans **10 lesson folders** (`Clase 1` through `Clase 10`, with `Clase 6` living inside `Clase 7` materials). All source files use the `.java` extension. Some lessons include `.uxf` UML diagram files created with UMLet.
...
- Lessons 7–9 add production concerns: structured logging, the DAO design pattern (`PersonaDAO`), and connection pooling.
...
| `Clase 4/` | Arrow functions |
| `Clase 5/` | Callback functions |
| `Clase 6/` | `setTimeout`, `setInterval`, live clock (Tarea Especial - Reloj) |
| `Practica JS/` | Standalone exercises and practice scripts |
