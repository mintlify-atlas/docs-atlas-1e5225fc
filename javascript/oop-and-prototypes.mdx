...
description: "Build object-oriented JavaScript using ES6 class syntax, extend classes with inheritance, apply polymorphism, check types with instanceof, and handle errors with try-catch — from Clases 1–4."
---
