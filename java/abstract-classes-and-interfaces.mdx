---
title: "Abstract Classes and Interfaces in Java OOP Design"
sidebarTitle: "Abstracts & Interfaces"
description: "Learn when to use abstract classes versus interfaces in Java, build the IAccesoDatos CRUD interface, and define abstract shape methods."
---
...
```java title="test/TestAbstractas.java"
package test;
