...
description: "Learn how to model a computer store system in Java using class inheritance, constructors, getters/setters, and toString — based on the MundoPC exercises from Clase 1."
---
...
public class MundoPc {
    public static void main(String[] args) {
        ...
        // --- Dell / Lenovo / Apple / Asus / Acer / MSI / Razer / Samsung (same pattern) ---
        ...
        // Fill orden1 up to the 10-computer limit
