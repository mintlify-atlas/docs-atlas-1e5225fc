...
description: "Learn the JavaBeans convention in Java — private fields, public getters and setters, and a no-arg constructor — with the Clase 8 JavaBeans exercise as a working example."
---
...
public class persona implements Serializable {
    ...
    // Rule 1 — mandatory no-arg constructor
    public persona() {
    }

    // Convenience constructor (optional, not part of the spec)
    public persona(String nombre, String apellido) {
        this.nombre = nombre;
        this.apellido = apellido;
    }

    // Rule 3 — public getter
    public String getNombre() {
        return nombre;
    }

    // Rule 3 — public setter
    public void setNombre(String nombre) {
        this.nombre = nombre;
    }
...
public class TestJavaBeans {
    public static void main(String[] args) {
        // Instantiate with the no-arg constructor
        Persona persona = new Persona();

        // Set values through public setters
        persona.setNombre("Juan");
        persona.setApellido("Perez");

        // toString() gives a readable summary
        System.out.println("persona = " + persona);

        // Read values through public getters
