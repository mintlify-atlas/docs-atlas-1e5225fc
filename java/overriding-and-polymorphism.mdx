...
description: "Master Java method overriding with @Override, runtime polymorphism using parent-type references, and safe type checking with the instanceof operator, from Clase 4."
---
...
```java title="test/TestPolimorfismo.java"
package test;
...
```java title="test/TestInstanceOf.java"
package test;
...
```java title="test/TestInstanceOfEjercicio.java"
package test;
...
public class TestSobreescritura {
    public static void main(String[] args) {
        ...
        empleado1 = new Gerente("Jose", 5000, "Sistemas");
        // determinarTipo(empleado1); // uncomment to run
    }
