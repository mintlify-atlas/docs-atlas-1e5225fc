---
title: "CRUD Operations on PostgreSQL with psycopg2"
sidebarTitle: "CRUD Operations"
description: "Perform INSERT, UPDATE, DELETE, and SELECT operations on PostgreSQL using psycopg2 parameterized queries, commit transactions, and check rowcount for affected rows — from Clase 5."
---
